...
class AndroidBaseView extends View {
  ...
  removeView() {
    ...
    var initialPos = (direction == 1) ? width : '-' + width;
    var finalPos = (direction == 1) ? '-' + width : width;
    var fromScreenId = window.__CACHED_SCREENS[window.__CURR_SCREEN].screen.layout.idSet.id;
    var toScreenId =  window.__CACHED_SCREENS[window.__PREV_SCREEN].screen.layout.idSet.id;
