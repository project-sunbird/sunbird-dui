...
class AlternateModuleDetailScreen extends View {
    ...
    getLineSeperator = () => {
            ...
            getHeader = () => {
                    var headerLayout = ( < LinearLayout height = "wrap_content"
                        width = "match_parent"
                    ...
                    getBody = () => {
                        var bodyLayout = ( < LinearLayout height = "match_parent"
                            width = "match_parent"
                            root = "true"
                            orientation = "vertical"
                            ...
                            <
                            TextView id = { this.idSet.downloadProgressText } test = "Fetching spine"
                            height = "match_parent"
                            gravity = "center"
                            width = "match_parent" / >
                            <
                        ...
                        render() {
                            ...
                            this.layout = ( <
                                ...
                                <
                                ProgressButton id = { this.idSet.playButtonContainer } width = "match_parent"
                                visibility = "gone"
                                isCourse = "true"
                                contentDetails = { this.module } buttonText = "DOWNLOAD"
                                localStatus = { this.localStatus } identifier = { this.module.identifier }
                                />
