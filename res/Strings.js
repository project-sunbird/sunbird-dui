...
const stringsRes = {
	...
	"hi_IN" : {
		...
		OPTION_OTHER : "अन्य",
		MODULE_NAME : "मोड्यूल का नाम",
		CURRENT_LOCATION : "वर्तमान  लोकेशन",
		HOBBIES : "शौक",
		...
		ERROR_OFFLINE_MODE : "कोई इंटरनेट, ऑफ़लाइन मोड नहीं",
		...
		UNKNOWN_QR : "कोई पाठ्यक्रम QR कोड से संबद्ध नहीं हुई",
	...
	"te_IN" : {
		...
		CAMERA_PERMISSION_SETTINGS : "అనుమతులు ఇవ్వడానికి సెట్టింగులకి వెళ్లి %s ఏప్ సెలెక్ట్ చేసుకొని కెమెరాకి అనుమతిపై క్లిక్ చెయ్యండి.",
	...
	"mr_IN" : {
		...
		QUIZ : "प्रश्नोत्तरी ",
		RESOURCES_BNAV : "संसाधने",
		RESOURCES_LW : "संसाधने",
		...
		NO_CHANGE : "कोणतेही बदल केले नाहीत",
