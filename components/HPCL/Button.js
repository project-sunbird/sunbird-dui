...
// const BigButtonPrimary = require('./Button/BigButtonPrimary');
// const BigButtonSecondary = require('./Button/BigButtonSecondary');
// const SmallButtonPrimary = require('./Button/SmallButtonPrimary');
// const SmallButtonSecondary = require('./Button/SmallButtonSecondary');
// const StepperButton = require('./Button/StepperButton');
  ...
  buttonDecision = () => {
    switch (this.props.type) {
      case "BigButton_Primary_DB":
        ...
        this.textStyle = TextStyle.textStyle.blueButton;
        this.text = this.props.text;
        break;

      case "BigButton_Primary_WB":
        this.layoutStyle = Styles.Params.BigButton.Primary_WB_Layout;
        this.textStyle = TextStyle.textStyle.whiteButton;
        this.text = this.props.text;
        break;
      ...
      case "StepperButton_WB":
        ...
        this.textStyle = TextStyle.textStyle.darkButton;
        this.text = this.props.text;
        break;
